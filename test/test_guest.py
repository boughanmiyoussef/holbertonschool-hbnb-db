...
class TestGuest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.guest = Guest("Youssef", "Boughanmi",
                           "Youssef.Boughanmi@example.com", "password123")

    def test_created_guest(self):
        self.assertEqual(self.guest.first_name, "Youssef")
        self.assertEqual(self.guest.last_name, "Boughanmi")
        self.assertEqual(self.guest.email, "Youssef.Boughanmi@example.com")
