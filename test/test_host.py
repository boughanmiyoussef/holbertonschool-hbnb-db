...
class TestHost(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.host = Host("Youssef", "Boughanmi",
                         "Youssef.Boughanmi@example.com", "password123")

    def test_create_host(self):
        self.assertEqual(self.host.first_name, "Youssef")
        self.assertEqual(self.host.last_name, "Boughanmi")
        self.assertEqual(self.host.email, "Youssef.Boughanmi@example.com")
